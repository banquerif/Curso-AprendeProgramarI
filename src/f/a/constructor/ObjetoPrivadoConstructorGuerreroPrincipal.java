//CREAR UN GUERRERO MEDIANTE OBJETOS CON ATRIBUTOS PRIVADOS | 

package f.a.constructor;

import java.io.IOException;

public class ObjetoPrivadoConstructorGuerreroPrincipal {

	public static void main(String[] args) {
		
		ObjetoPrivadoConstructorGuerrero guerrero_a = new ObjetoPrivadoConstructorGuerrero("Guerrero1", 10, 100);
		ObjetoPrivadoConstructorGuerrero guerrero_b = new ObjetoPrivadoConstructorGuerrero("Guerrero2", 10, 100);
		
		int golpe_total;
		
		// PASO DE VALORES A LOS ATRIBUTOS SIN UTILIZAR (CONSTRUCTOR)
